...
export class BookingServiceService{
    ...
    constructor() {
      this.bookingList=[new Booking( 1, "Juan Pérez", "+34 600 123 456", "juan.perez@example.com", 4, "Prefiere mesa cerca de la ventana.", new
         ...
         new Booking( 4, "María Fernández", "+34 600 345 678", "maria.fernandez@example.com", 3, "Traerá un pastel decumpleaños.", new Date("2024-12-22T18:30:00"), new Date("2024-12-02T09:15:00"),BookingStatus.PENDING ),
